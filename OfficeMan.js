//http://blog.sklambert.com/html5-game-tutorial-module-pattern/?lang=pl

(function () {
    // define variables
    var canvas = document.getElementById('cnvOfficeMan');
    var ctx = canvas.getContext('2d');
    var player = {};
    var ground = [];
    var platformWidth = 32;
    var platformHeight = 32;// canvas.height - platformWidth * 4;
    ...
    function startGame() {
        ...
        player.height = 16;
        player.speed = 1;
        player.sheet = new SpriteSheet('imgs/normal_walk33.png', player.width, player.height);
        player.anim = new Animation(player.sheet, 6, 0, 7);
